...
import lk.zeamac.app.ceylonhandicraft.Adapter.ViewPagerAdapter;
...
public class NavigationActivity extends AppCompatActivity {
    ...
    public void setDotIndicator(int position) {
        ...
        for (int i = 0; i < dots.length; i++) {
            ...
            dots[i].setTextColor(getResources().getColor(R.color.purple_700, getApplicationContext().getTheme()));
